...
Карточки, попавшие в область скана соответствия, также показывают вкладку **Соответствие** на своей странице деталей (управляется правом `security_compliance.view`). Она перечисляет каждую находку, в настоящее время привязанную к карточке, с теми же действиями «Подтвердить / Принять / **Создать риск** / **Открыть риск**», что и в GRC, — так Application Owner может сортировать свои находки, не покидая карточку. То же правило автоматического скрытия действует и для вкладки **Риски** в деталях карточки: обе вкладки появляются только тогда, когда у карточки действительно есть связанные элементы, чтобы карточки без GRC-активности не таскали с собой пустые вкладки.
