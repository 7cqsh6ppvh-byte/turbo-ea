...
export default function AwsDiagramsPage() {
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", mb: 3 }}>
        ...
        <Button variant="contained" sx={{ bgcolor: "#FF9900", "&:hover": { bgcolor: "#E68900" } }} onClick={() => setCreateOpen(true)}>
          {t("newDiagram")}
        </Button>
      </Box>
        ...
        >
          {diagrams.map((d) => (
            <Card key={d.id} variant="outlined">
              <CardActionArea onClick={() => navigate(`/aws/${d.id}/edit`)}>
                <CardContent>
      ...
      <Dialog open={createOpen} onClose={() => setCreateOpen(false)} maxWidth="xs" fullWidth>
        ...
        <DialogActions>
          ...
          <Button variant="contained" onClick={handleCreate} disabled={!newName.trim() || creating}
            sx={{ bgcolor: "#FF9900", "&:hover": { bgcolor: "#E68900" } }}>
