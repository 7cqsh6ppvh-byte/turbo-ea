...
export function ArchimateDiagramsPage() {
    ...
    <Box sx={{ p: 3 }}>
      ...
      {loading ? (
        ...
        <Box sx={{ textAlign: "center", mt: 8, color: "text.secondary" }}>
          <Typography variant="h6">No ArchiMate diagrams yet</Typography>
        ...
        >
          {diagrams.map((d) => (
            <Card key={d.id} variant="outlined">
              <CardActionArea onClick={() => navigate(`/archimate/${d.id}/edit`)}>
                <CardContent>
      ...
      <Dialog open={createOpen} onClose={() => setCreateOpen(false)} maxWidth="xs" fullWidth>
        <DialogTitle>New ArchiMate Diagram</DialogTitle>
        <DialogContent>
          <TextField
            autoFocus
            fullWidth
