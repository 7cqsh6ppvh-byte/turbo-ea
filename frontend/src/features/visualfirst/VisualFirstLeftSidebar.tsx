...
import { VisualFirstElementsTree } from "./VisualFirstElementsTree";
import { VisualFirstViewsTree } from "./VisualFirstViewsTree";
import { VisualFirstElementPalette } from "./VisualFirstElementPalette";
  ...
  return (
    ...
    >
      ...
      <Box sx={{ flex: 1, overflow: "hidden" }}>
        ...
        {tab === "views" && <VisualFirstViewsTree currentDiagramId={currentDiagramId} />}
        {tab === "palette" && <VisualFirstElementPalette activeTypes={activeTypes} />}
      </Box>
    </Box>
  );
}
