...
const C4DiagramsPage = lazy(
  () => import("@/features/c4/C4DiagramsPage").then((m) => ({ default: m.C4DiagramsPage })),
);
const C4DiagramEditor = lazy(
  () => import("@/features/c4/C4DiagramEditor").then((m) => ({ default: m.C4DiagramEditor })),
);
