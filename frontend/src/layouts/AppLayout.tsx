...
export default function AppLayout({ children, user, onLogout }: Props) {
  ...
  const bpmEnabled = isEnabled("bpm");
  const ppmEnabled = isEnabled("ppm");
  const grcEnabled = isEnabled("grc");
  const rwfEnabled = isEnabled("rwf");
  const visualFirstEnabled = isEnabled("visualfirst");
