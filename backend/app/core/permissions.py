...
APP_PERMISSIONS: dict[str, dict] = {
    ...
    "aws": {
        "label": "AWS",
        "permissions": {
            "aws.view": "View AWS architecture diagrams and elements",
            "aws.manage": "Create, edit, and delete AWS architecture diagrams and elements",
        },
    },
    "azure": {
        "label": "Azure",
        "permissions": {
            "azure.view": "View Azure architecture diagrams and elements",
            "azure.manage": "Create, edit, and delete Azure architecture diagrams and elements",
        },
    },
    "gcp": {
        "label": "GCP",
        "permissions": {
            "gcp.view": "View GCP architecture diagrams and elements",
            "gcp.manage": "Create, edit, and delete GCP architecture diagrams and elements",
        },
    },
    "c4": {
        "label": "C4 Model",
