...
APP_PERMISSIONS: dict[str, dict] = {
    ...
    "rwf": {
        ...
        "permissions": {
            "rwf.view": (
                "View branch list, diff view, and snapshot list. "
                "Required to see the Releases nav item."
            ),
            "rwf.contribute": (
                "Create branches, edit cards/relations/diagrams in a branch, "
                "and submit a branch for review."
            ),
            "rwf.approve": ("Approve, reject, and execute the merge of a branch into main."),
        },
    },
    "admin": {
        "label": "Admin",
...
EA_ARCHITECT_PERMISSIONS: dict[str, bool] = {
    "inventory.view": True,
    "inventory.create": True,
    "inventory.edit": True,
    "inventory.archive": True,
